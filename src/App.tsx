...
import {MessagesContainer, MessagesContext} from './components/MessagesContext'
...
const InnerApp: React.FC = () => {
    ...
    return (
        <div>
            ...
            <button onClick={() => messagesContext.showMessage(<Dialog/>)}>Show message</button>
            <div>
...
const Dialog: React.FC = () => (
    <div
        style={{width: '400px', height: '200px', border: 'navy', backgroundColor: 'gainsboro', fontSize: '24px'}}
    >
        Hi there from dialog! Profile;
    </div>
)
